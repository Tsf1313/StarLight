...
import { Users, CheckCircle2, Clock, XCircle, Search, Filter, Download, UserPlus } from 'lucide-react';
    ...
    <div className="animate-fade-in" style={{ maxWidth: '1400px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem' }}>
           ...
           <button className="btnSolid scale-btn hover-lift" style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
      ...
      <div style={{ background: 'white', borderRadius: '12px', border: '1px solid #e2e8f0', overflow: 'hidden' }}>
         {/* Toolbar */}
         <div style={{ padding: '1rem 1.5rem', borderBottom: '1px solid #e2e8f0', display: 'flex', gap: '1rem', alignItems: 'center' }}>
            <div style={{ position: 'relative', flex: 1, maxWidth: '400px' }}>
               ...
               <input 
                 ...
                 style={{ width: '100%', padding: '0.625rem 1rem 0.625rem 2.5rem', border: '1px solid #e2e8f0', borderRadius: '8px', fontSize: '0.875rem', outline: 'none' }}
               />
            </div>
            <button className="btnOutline scale-btn" style={{ padding: '0.625rem 1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
